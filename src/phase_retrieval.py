"""Phase retrieval main script"""
#Files of this project are modified versions of 'https://github.com/AshishBora/csgm', which
...
if __name__ == '__main__':
    ...
    PARSER.add_argument('--input-path-pattern', type=str, default='./images/*.jpg', help='Pattern to match to get images')
